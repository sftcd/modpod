...
This repository contains information relating to the proposed modpod
working group of the IETF.  The purpose of this effort is to improve
moderation procedures.
...
Right now we're working on a charter.  See charter.md for details.
